...
import com.example.easyRide.integration.BaseIntegrationTest;
...
public class DatabaseIntegrationTest extends BaseIntegrationTest {
    ...
    public void testH2DatabaseConnection() {
        ...
        Integer result = jdbcTemplate.queryForObject("SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLES.TABLE_NAME = 'DRIVERS'", Integer.class);
